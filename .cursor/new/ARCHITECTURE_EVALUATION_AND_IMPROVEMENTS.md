...
**バージョン**: 1.0  
**評価者**: AI開発アシスタント  
**対象**: `.cursor/new/`配下の全23個のアーキテクチャ設計文書

---

## エグゼクティブサマリー

`.cursor/new/`ディレクトリに配置された新アーキテクチャ設計文書群を包括的に評価した結果、**全体的に高品質で実践的な設計**であることが確認されました。特にデータ駆動設計、依存性注入（DI）パターン、ECS統合、内部エディタの一貫性は優れています。
...
```
.cursor/new/
├── 00_INDEX.md                      # 【新規】マスタードキュメント
├── 01_core/
│   ├── architecture-overview.md     # 統合: core-architecture + dirs-and-targets
│   ├── design-principles.md         # 統合: design-principles*
│   └── migration-plan.md
├── 02_data/
│   ├── json-schema.md
│   └── hot-reload.md                # 分割: core-architecture から抽出
├── 03_systems/
│   ├── td-systems.md                # 統合: td-systems + linea-td-detailed
│   ├── ui-system.md
│   ├── animation-system.md          # 統合: motion-animation + motion-editor
│   ├── combat-collision.md
│   ├── camera-viewport.md
│   ├── audio-system.md
│   ├── particle-system.md
...
├── 04_editor/
│   ├── internal-editor.md
│   └── editor-workflows.md          # 【新規】操作ガイド
├── 05_libraries/
│   └── libraries-guide.md           # 統合: libs* + raylib_resource
└── 06_advanced/
    └── game-state-and-stage.md
```

#### マスタードキュメント (`00_INDEX.md`)
```markdown
# 新アーキテクチャ設計文書 - 索引

## はじめに
このディレクトリには新アーキテクチャの全設計文書が含まれています。

## 推奨読書順

### 初めての方
1. [アーキテクチャ概要](01_core/architecture-overview.md)
2. [設計原則](01_core/design-principles.md)
3. [移行計画](01_core/migration-plan.md)

### システム実装者
1. [JSONスキーマ](02_data/json-schema.md)
2. [TDシステム](03_systems/td-systems.md)
3. [UIシステム](03_systems/ui-system.md)

### エディタ開発者
1. [内部エディタ設計](04_editor/internal-editor.md)
2. [エディタワークフロー](04_editor/editor-workflows.md)
